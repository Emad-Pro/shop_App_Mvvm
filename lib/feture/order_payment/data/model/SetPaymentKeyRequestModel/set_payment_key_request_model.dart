class SetPaymentKeyRequestModel {
  String? authToken;
  String? amountCents;
  int? expiration;
  String? orderId;
  ...
  SetPaymentKeyRequestModel.fromJson(Map<String, dynamic> json) {
    authToken = json['auth_token'];
    amountCents = json['amount_cents'];
    expiration = json['expiration'];
    orderId = json['order_id'];
    billingData =
        json['billing_data'] != null ? new BillingData.fromJson(json['billing_data']) : null;
